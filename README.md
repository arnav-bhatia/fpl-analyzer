...
**Home Page** - The main page which loads all the data, and gives a very quick summary of a manager's season so far and league standings.

**My Team** - Provides a more indepth look into the manager's team, including an overview of their gw history, and player stats.
